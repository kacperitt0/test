...
(function () {
    ...
    (function () {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[Top Liquidy]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, stupidass!"], 30, 500, function () {
                    ...
                    writeLine(["<i style='color: #F62459'>$$$Top Liquidy on top$$$</i>"], 120, 500, function () {
